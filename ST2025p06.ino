...
#define VERSION_NUMBER  2025.06        // Version number appears in Display #1 / Credit display at start of game
...
// Other functionss needing to be defined:
...
// ########## SELF TEST CAN RUN ANY OOF THE LIGHTSHOWS ##########
